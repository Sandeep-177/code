...
<head>
    ...
    <link rel="stylesheet" href="../admin_css/addNewSubCategory.css">
</head>
<body>
    <!-- Header -->
    <?php
    ...
    <!-- content -->
    <div class="divFist">
     <p class="fist" style="background-color: rgb(215, 248, 215); color: rgb(108, 143, 108);">Add New Subcategory</p>
     <div>
        <form id="orders">
        <label for="locEdt">Category</label>
        <input type="text" name="locEdt" class="locedt" id="input1">
        <label for="locEdt3">Enter Subcategory Name:</label>
     ...
     <p class="fist" style="background-color: rgb(227, 233, 227); color: rgb(130, 136, 130);"><b>Note: </b> Please note that added subcategories will be seeen by users and vendors.</p>
