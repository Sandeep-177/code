...
<body>
    ...
    <section id="category">
        ...
        <div class="catCard" style=" background-image: url('/code/images/deep-cleaning2.png'); background-size: cover;">
            <div class="tryi">
                <h3>Deep Cleaning</h3>
        ...
        <div class="catCard" style=" background-image: url('/code/images/regular-cleaning.jpg'); background-size: cover;">
            <div class="tryi">
