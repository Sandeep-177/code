...
<body>
    ...
    <section id="category">
        ...
        <div class="catCard" style=" background-image: url('../images/ac-installtion.jpg'); background-size: cover;">
            <div class="tryi">
        ...
        <div class="catCard" style=" background-image: url('../images/AC-Repair.jpg'); background-size: cover;">
            <div class="tryi">
                <h3>AC Repair</h3>
                <p>Get plumbing issues fixed quickly and efficiently.</p>
                <button class="catButton">Book Now</button>
        ...
        <div class="catCard" style=" background-image: url('../images/ac-maintainance2.jpeg'); background-size: cover;">
            <div class="tryi">
