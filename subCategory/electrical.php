...
<body>
    ...
    <section id="category">
        ...
        <div class="catCard" style=" background-image: url('/code/images/electric-rewiring.jpg'); background-size: cover;">
            <div class="tryi">
        ...
        <div class="catCard" style=" background-image: url('/code/images/home-appliances-repair2.jpg'); background-size: cover;">
            <div class="tryi">
        ...
        <div class="catCard" style=" background-image: url('/code/images/light-installation.jpg'); background-size: cover;">
            <div class="tryi">
