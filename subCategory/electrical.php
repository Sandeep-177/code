...
<body>
    ...
    <section id="category">
        ...
        <div class="catCard" style=" background-image: url('../images/electric-rewiring.jpg'); background-size: cover;">
            <div class="tryi">
        ...
        <div class="catCard" style=" background-image: url('../images/home-appliances-repair2.jpg'); background-size: cover;">
            <div class="tryi">
        ...
        <div class="catCard" style=" background-image: url('../images/light-installation.jpg'); background-size: cover;">
            <div class="tryi">
