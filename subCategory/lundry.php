...
<body>
    ...
    <section id="category">
        ...
        <div class="catCard" style=" background-image: url('../images/washing-machine-repair.jpg'); background-size: cover;">
            <div class="tryi">
        ...
        <div class="catCard" style=" background-image: url('../images/dryer-repair.webp'); background-size: cover;">
            <div class="tryi">
                <h3>Dryer Repair</h3>
                <p>Get plumbing issues fixed quickly and efficiently.</p>
                <button class="catButton">Book Now</button>
