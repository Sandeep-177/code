...
<body>
    ...
    <section id="category">
        ...
        <div class="catCard" style=" background-image: url('../images/wedding-photography.jpg'); background-size: cover;">
            <div class="tryi">
        ...
        <div class="catCard" style=" background-image: url('../images/event-photography.webp'); background-size: cover;">
            <div class="tryi">
