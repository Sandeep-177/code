...
<body>
    ...
    <section id="category">
        ...
        <div class="catCard" style=" background-image: url('../images/leak-reapir.jpg'); background-size: cover;">
            <div class="tryi">
                <h3>Leak Repairs</h3>
        ...
        <div class="catCard" style=" background-image: url('../images/pipe-installation.jpg'); background-size: cover;">
            <div class="tryi">
        ...
        <div class="catCard" style=" background-image: url('../images/Bathroom-Drain-Cleaning.jpg'); background-size: cover;">
            <div class="tryi">
